...
class Players():
    ...
    def out(self, message):
        ...
        #'[ {} ] '.format(self.name)
        print(message)
        mysend(self.client, json.dumps({"action": "exchange_g", "message": message}))
...
def score(player1, player2, player1_hand, player2_hand):
    if total(player1_hand) == 21:
        ...
        print_results(player1, player2, player1_hand, player2_hand)
        print("\n{} and {} both busted.".format(player1.name, player2.name))
        player1.out('\nSorry, both of you busted\n')
        player2.out('\nSorry, both of you busted\n')
    elif total(player1_hand) > 21:
        print_results(player1, player2, player1_hand, player2_hand)
        print('\n{} busted. {} wins!\n'.format(player1.name, player2.name))
        player1.out('\nSorry, you busted. You lose.\n')
        player2.out('\n'+player1.name + ' busted. You win!\n')
    elif total(player2_hand) > 21:
        print_results(player1, player2, player1_hand, player2_hand)
        ...
        print_results(player1, player2, player1_hand, player2_hand)
        print('\n{} score is lower. {} wins!\n'.format(player1.name, player2.name))
        player1.out('\nSorry, your score is lower than ' + player2.name + '. You lose.\n')
        player2.out('\nCongratulations! You score is higher than ' + player1.name + '. You win!\n')
    elif total(player2_hand) < total(player1_hand):
        print_results(player1, player2, player1_hand, player2_hand)
        print('\n{} score is lower. {} wins!\n'.format(player2.name, player1.name))
        player2.out('\nSorry, your score is lower than ' + player1.name + '. You lose.\n')
        player1.out('\nCongratulations! You score is higher than ' + player2.name + '. You win!\n')
