...
def reset_window(self):
    ...
    label0 = Label(reset_window, text="Reset Password", padx=10, pady=20, font=('verdana', 16), bg="white")
    label0.pack()
    frame2 = Frame(reset_window, bg="white")
    label1 = Label(frame2, text="Username:", padx=10, pady=0, font=('verdana', 10), bg="white")
    label1.grid(row=0, column=0, sticky=W)
    button1 = Button(frame2, text='Send Code', command=send_button_click, bg="antiquewhite1", font=('verdana', 10))
    button1.grid(row=0, column=1, padx=10, pady=10, sticky=E)
    label1_r = Label(frame2, padx=10, pady=0, textvariable=string1, justify=LEFT, bg="white")
    label1_r.grid(row=0, column=2, sticky=W)
    label2 = Label(frame2, text='Verification Code:', padx=10, pady=10, font=('verdana', 10), bg="white")
    label2.grid(row=1, column=0, sticky=W)
    label2_r = Label(frame2, padx=10, pady=10, textvariable=string2, justify=LEFT, bg="white")
    label2_r.grid(row=1, column=2, sticky=W)
    label3 = Label(frame2, text='Password:', padx=10, pady=10, font=('verdana', 10), bg="white")
    label3.grid(row=2, column=0, sticky=W)
    label3_r = Label(frame2, padx=10, pady=10, textvariable=string3, justify=LEFT, bg="white")
    label3_r.grid(row=2, column=2, sticky=W)
    label4 = Label(frame2, text='Confirm Password', padx=10, pady=10, font=('verdana', 10), bg="white")
    label4.grid(row=3, column=0, sticky=W)
    label4_r = Label(frame2, padx=10, pady=10, textvariable=string4, justify=LEFT, bg="white")
    label4_r.grid(row=3, column=2, sticky=W)
    entry1 = Entry(frame2, validate='focusout', validatecommand=(CMDusername_validate, '%P'), bg="white")
    ...
    entry3 = Entry(frame2, show='●', width=35, validate='focusout', validatecommand=CMDconfirm_validate, bg="white")
    entry3.grid(row=2, column=1, padx=10, pady=10, sticky=W)
    entry4 = Entry(frame2, show='●', width=35, validate='focusout', validatecommand=CMDconfirm_validate, bg="white")
    entry4.grid(row=3, column=1, padx=10, pady=10, sticky=W)
    frame2.pack()
    button2 = Button(reset_window, text='Reset', width=10, command=reset_button_click, font=('verdana', 10), bg="antiquewhite1")
