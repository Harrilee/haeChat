...
def register_window(self):
    ...
    label0 = Label(register_window, text="Create a New Account", padx=10, pady=20, font=('verdana', 16), bg="white")
    label0.pack()
    frame2 = Frame(register_window, bg="white")
    ...
    label2 = Label(frame2, text='Password:', padx=10, pady=10, font=('verdana', 10), bg="white")
    ...
    label3 = Label(frame2, text='Confirm Password:', padx=10, pady=10, font=('verdana', 10), bg="white")
    ...
    label4 = Label(frame2, text='Email Address:', padx=10, pady=10, font=('verdana', 10), bg="white")
    ...
    label5 = Label(frame2, text='Verification Code:', padx=10, pady=10, font=('verdana', 10), bg="white")
    label5.grid(row=4, column=0, sticky=W)
    label5_r = Label(frame2, padx=10, pady=10, textvariable=string5, justify=LEFT, bg="white")
    ...
    button1 = Button(frame2, text='Send Code', command=send_button_click, font=('verdana', 10), bg="antiquewhite1")
    ...
    frame2.pack()
    button2 = Button(register_window, text='Register', width=10, command=register_button_click, font=('verdana', 10), bg="antiquewhite1")
